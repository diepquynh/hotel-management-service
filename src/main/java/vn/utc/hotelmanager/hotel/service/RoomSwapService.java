...
public class RoomSwapService {
    ...
    @Autowired
    public RoomSwapService(UserRepository userRepository, RoomRepository roomRepository,
                           RoomSwapRepository roomSwapRepository, BookingRepository bookingRepository,
                           ReceiptRepository receiptRepository, ReceiptRoomRepository receiptRoomRepository) {
        this.userRepository = userRepository;
        this.roomRepository = roomRepository;
        this.roomSwapRepository = roomSwapRepository;
    ...
    public void swapRoomForUser(RoomSwapRequestDTO swapRequest) {
        ...
        User thisUser = userRepository.findById(swapRequest.getUserId())
                .orElseThrow(
